...
import { Phone, MessageCircle, Calendar, MapPin, Wrench, Laptop, Cctv, Printer, Tv, WashingMachine, Refrigerator, AirVent, Zap } from 'lucide-react';
...
const services = [
  ...
  { id: 'washing', name: 'Washing Machine', icon: WashingMachine, price: 'From ₹600' },
